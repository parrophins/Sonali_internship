...
export const deleteUser = (id, address) => async (dispatch) => {
    ...
    try {
        ...
        if (result.data.message) {
            dispatch(getDeleteFailed(result.data.message));
        } else {
...
//             data: { address }, // Pass `address` in the request body if required
//         });
//         if (response.data.success) {
//             dispatch({ type: "DELETE_USER_SUCCESS", payload: deleteID });
